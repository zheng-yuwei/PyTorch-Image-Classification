...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args: typing.List[BlockArgs] = None,
        ...
        # 主干网络
        in_channels = 3  # rgb
        out_channels = round_filters(32, self._global_params)  # number of features channels
        ...
        # Head
        in_channels = block_args.output_filters  # features of final block
        out_channels = round_filters(1280, self._global_params)
        self._conv_head = Conv2d(in_channels, out_channels, kernel_size=1, bias=False)
        self._bn1 = nn.BatchNorm2d(num_features=out_channels, momentum=bn_mom, eps=bn_eps)

        # 最后线性全连接层
        self._swish_head = Swish()
        self._swish_fc = Swish()
    ...
    def extract_features(self, inputs):
        ...
        # Stem
        x = self._swish_head(self._bn0(self._conv_stem(inputs)))
        ...
        # Head
        x = self._swish_fc(self._bn1(self._conv_head(x)))
